...
const CACHE_NAME = 'mzansi-artisan-core-v0.1-13';
const CORE_ASSETS = [
  './',
  './index.html',
  './README.md',
...
self.addEventListener('fetch', (event) => {
  ...
  // Navigation/app shell: network first so a deployed update replaces stale HTML.
  ...
  // Static Trade Pack/Core assets remain cache-first for fast, low-data offline use.
  event.respondWith(
